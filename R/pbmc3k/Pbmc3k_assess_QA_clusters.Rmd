...
QA_output_name = "512_graph_snn_k5_dim15_gf005_trimmed_15_bqm2_v2.gexf"
...
cc_pbmc3k_QA <- FindClusters(cc_pbmc3k_QA, verbose = FALSE, resolution = 0.3, algorithm = 1)
...
# Check with the reference (files' prefix: "rc")
