...
# pbmc3k_dataprep <- pbmc3k[,1:2048]
pbmc3k_dataprep <- pbmc3k[,1:1024]
# pbmc3k_dataprep <- pbmc3k[,1:512]
# pbmc3k_dataprep <- pbmc3k[,1:256]
# pbmc3k_dataprep <- pbmc3k[,1:128]
...
file_name = ''.join(["./graphs_data_prep/", str(n), "_graph_snn", "_k", str(k), "_dim", str(dim), type[id_type], str(ord), ".gexf"])
...
file_name = ''.join(["./graphs_data_prep/", str(n), "_graph_snn", "_k", str(k), "_dim", str(dim), type[id_type], str(ord), ".png"])
