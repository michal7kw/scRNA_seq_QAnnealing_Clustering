...
file_name = ''.join(["../../graphs/kidney/", str(n), "_graph_snn", "_k", str(k), "_dim", str(dim), type[id_type], str(ord), "selected_to_prune.gexf"])
...
file_name = ''.join(["../../graphs/kidney/", str(n), "_graph_snn", "_k", str(k), "_dim", str(dim), type[id_type], str(ord), "selected_to_prune.png"])
...
file_name = ''.join(["../../graphs/kidney/", str(n), "pru_graph_snn", "_k", str(k), "_dim", str(dim), type[id_type], str(ord), ".gexf"])
...
file_name = ''.join(["../../graphs/kidney/", str(n), "pru_graph_snn", "_k", str(k), "_dim", str(dim), type[id_type], str(ord), ".png"])
plt.savefig(file_name, bbox_inches='tight')
```
