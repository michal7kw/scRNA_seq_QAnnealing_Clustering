...
name = "239pru_graph_snn_k5_dim15_trimmed_15"
gexf_graph_name = ''.join(["../../graphs/pbmc3k/", name, ".gexf"])
png_graph_name = ''.join(["../../graphs/pbmc3k/", name, ".png"])
png_graph_name2 = ''.join(["../../graphs/pbmc3k/", name, "_2.png"])
